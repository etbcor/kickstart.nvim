...
-- etbcor's keybinds
-- vim.keymap.set('n', '<Leader>o', ':Oil<Enter>', { desc = '[O]pen file browser' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- If encountering errors, see telescope-fzf-native README for installation instructions
        ...
        build = 'make', -- `build` means run this on plugin install/update
